...
+----------------------------------------+-------------------------------+------------------------------------------------------------------------------------------------------------+
| Use GPU Model                          | bool                          | The GPU Model will be used if the option is not toggled on. The CPU Model will be used if not toggled on.  |
+----------------------------------------+-------------------------------+------------------------------------------------------------------------------------------------------------+
...
- Use GPU Model (Default: false)
   The GPU Model will be used if the option is not toggled on. The CPU Model will be used if not toggled on.
