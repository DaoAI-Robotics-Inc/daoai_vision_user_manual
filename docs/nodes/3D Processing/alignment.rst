...
.. image:: Images/alignment/alignment_node_overview_1.png
   :align: center
...
+========================================+===============================+=================================================================================+
| Hypothesis                             | vector<Pose>                  | The results of poses. Usually from Mod Finder, Reconstruct etc.                 |
+----------------------------------------+-------------------------------+---------------------------------------------------------------------------------+
...
.. image:: Images/alignment/alignment_node_node_settings_models.png
   :align: center
...
3. As the image below, the model defined is off in z-axis (lower than the center of axis). And you find that there is a transformation tree node available. What should you do to bring the object to the center of axis?
